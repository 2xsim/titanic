<div class="container">
    <div class="main-body">
        <div class="row my-2"><img class="social-cover" src="./img/azrul-aziz-DsvY9NRykRg-unsplash.jpg" alt=""></div>
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <div class="mt-3">
                                <h4>Ezekias Mike Prince SIMEDA</h4>
                ...
                <div class="card mt-3">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <span class="text-secondary">Prince SIMEDA</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            <h6 class="mb-0"><i class="fab fa-instagram-square fa-lg mx-1 text-danger"></i>Instagram
                            </h6>
                            <span class="text-secondary">@2xsim_</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <p class="note" style="text-align: justify">Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit.
                                    Mauris
                                    nunc arcu,
                                    ...
                                    placerat, viverra tellus non, pulvinar risus.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 mb-3">
