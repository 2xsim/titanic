...
path.setAttribute(
    "d",
    `m 0,30 c 16.920055,0 8.8823519,-${bump} 30,-${bump} 21.117648,0 13.001352,${bump} 30,${bump} h 260`
);
const duration = 600;
...
const animate = (inPct) => {
    ...
    path.setAttribute(
        "d",
        `m 0,30 c 16.920055,0 8.8823519,-${newBump} 30,-${newBump} 21.117648,0 13.001352,${newBump} 30,${newBump} h 260`
    );
};
